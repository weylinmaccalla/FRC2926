...
public class Robot extends TimedRobot {
  ...
  private final VictorSP leftMotor1 = new VictorSP(6);
  private final VictorSP leftMotor2 = new VictorSP(7);

  SpeedControllerGroup leftmotors = new SpeedControllerGroup(leftMotor1, leftMotor2);

  private final VictorSP rightMotor1 = new VictorSP(8);
  private final VictorSP rightMotor2 = new VictorSP(9);
